...
export class GeofenceEditComponent implements AfterViewInit {
 ...
 private readonly genericColors = ['#56A6B6', '#464E50', '#56B691', '#BF8B8A', '#E95794'];
  ...
  public pageTitle: string = "Map";
   infobox;
   constructor(private _location: Location,private snackBar: MatSnackBar,private _dataService: MapService,private router: Router, private matIconRegistry: MatIconRegistry, private domSanitizer: DomSanitizer) { 
    ...
    onSubmit(){
      ...
      if(this.status==true){
        ...
        if(this.Coordinates.length==0){
          ...
          this._dataService.geofences.push(newGeofence);
