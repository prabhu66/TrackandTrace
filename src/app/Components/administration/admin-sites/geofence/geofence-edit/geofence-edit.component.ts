...
@Component({
  selector: 'app-asset-geofence-edit',
  templateUrl: './geofence-edit.component.html',
  styleUrls: ['./geofence-edit.component.css']
})
export class AssetGeofenceEditComponent implements AfterViewInit {
  ...
  public pageTitle: string = "Map";
   ...
   constructor(private _location: Location,private snackBar: MatSnackBar, private _assetService:AssetService,private _dataService: MapService,private router: Router, private matIconRegistry: MatIconRegistry, private domSanitizer: DomSanitizer) { 
